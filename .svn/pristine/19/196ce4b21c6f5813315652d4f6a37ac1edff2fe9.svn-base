...
mn_lap_data_anggota.Enabled = False
mn_lap_data_buku.Enabled = False
mn_lap_pinjam.Enabled = False
mn_history.Enabled = False
mn_login.Enabled = False
mn_logout.Enabled = False
End Sub
Private Sub MDIForm_Load()
Me.Picture = LoadPicture(App.Path & "\gambar\perpustakaan.jpg")
frmLogin.Show
Call awal
...
Dim tanya
tanya = MsgBox("Anda yakin akan logout dari Aplikasi ?", vbInformation + vbYesNo, "Konfirmasi")
If tanya = vbYes Then
    Unload frmBuku
    Unload frmAnggota
    Unload frmStaff
    ...
    Unload frmSetting
    Unload frmAbout
    Unload frmLaporanAnggota
    Unload frmLaporanBuku
    Unload frmLaporanPeminjaman
    Unload frmGPass
